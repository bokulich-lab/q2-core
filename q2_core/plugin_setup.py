...
plugin = Plugin(
    ...
    description=(
        "This plugin computes prevalence-abundance core scores for "
        "features in relative-frequency feature tables."
    ),
)
...
plugin.methods.register_function(
    ...
    description=(
        ...
        "`min_rel_abundance`, then log-transformed with `offset`; both "
